  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mt-3">
        <span
          className="bg-black text-white text-[11px] px-3 py-1 rounded-full
      ...
      <h2
        className="text-[15px] font-semibold mt-2 leading-snug line-clamp-2
      dark:text-[#E5E7EB]"
      >
        {title}
      </h2>
